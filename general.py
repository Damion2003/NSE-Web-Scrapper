...
def getId(name):
    ...
    # return company_details.json()['identifier']
    return company_details.json()['info']['identifier']
#getId('tata motors') => TATAMOTORSEQN
# https://www.nseindia.com/api/search/autocomplete?q=tata%20motor
# https://www.nseindia.com/api/quote-equity?symbol=Tata%20Motors%20Finance%20Limited